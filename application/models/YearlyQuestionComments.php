<?php
class Model_YearlyQuestionComments extends Zend_Db_Table_Abstract{
    
    protected $_name='yearly_question_comments';
	...
	//Return all comments made on a yearly question identified by $pid
